  ...
  theme: {
    extend: {
      colors: {
        ...
        surface: { DEFAULT: "#f8f9ff", dim: "#cbdbf5", bright: "#f8f9ff", container: { DEFAULT: "#e5eeff", low: "#eff4ff", high: "#dce9ff", highest: "#d3e4fe", lowest: "#ffffff" }, variant: "#d3e4fe", tint: "#1353d8" },
        "on-surface": { DEFAULT: "#0b1c30", variant: "#434654" },
