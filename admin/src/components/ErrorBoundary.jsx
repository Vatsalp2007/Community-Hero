      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
          <div className="text-center max-w-md">
            ...
            <p className="text-sm text-gray-600 mb-4">
              To fix this, create a <code className="bg-gray-100 px-1.5 py-0.5 rounded text-xs">.env</code> file in the <code className="bg-gray-100 px-1.5 py-0.5 rounded text-xs">admin/</code> folder with your Firebase config.
            </p>
            <button 
